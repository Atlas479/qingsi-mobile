...
requirements = python3,kivy==2.1.0,sqlite3,requests,pyjnius,plyer,android
...
# (list) python-for-android whitelist of recipes to build
#p4a.whitelist =
...
# (str) Use a custom url for the Android SDK
# android.sdk_url =

# (str) Use a custom url for the Android NDK
# android.ndk_url =
...
# (bool) enables Android instrumentation installation
# android.add_compile_options = False

# (list) Gradle repositories to add {can be necessary for some android packages}
# please enclose in double quotes 
# e.g. android.gradle_repositories = "google()", "jcenter()", "maven { url 'https://kotlin.bintray.com/ktor' }"
#android.gradle_repositories =

# (list) Gradle dependencies to add {can be necessary for some android packages}
# please enclose in double quotes 
# e.g. android.gradle_dependencies = "implementation 'com.google.firebase:firebase-analytics:17.2.0'"
...
# (list) Gradle repositories to add {can be necessary for some android packages}
# please enclose in double quotes 
# e.g. android.add_gradle_repositories = "google()", "jcenter()", "maven { url 'https://kotlin.bintray.com/ktor' }"
#android.add_gradle_repositories =

# (list) Gradle dependencies to add {can be necessary for some android packages}
# please enclose in double quotes 
# e.g. android.add_gradle_dependencies = "implementation 'com.google.firebase:firebase-analytics:17.2.0'"
